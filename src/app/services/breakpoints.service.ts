import { Injectable, Provider, NgZone } from '@angular/core';
...
export const breakpointsProvider = function (breakpoints?: BreakpointConfig) {
    return { provide: BreakpointsService, useFactory: (ngZone) => new BreakpointsService(ngZone, breakpoints), deps: [NgZone] }
}
